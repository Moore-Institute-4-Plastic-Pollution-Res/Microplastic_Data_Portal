...
erDiagram
	...
	string SieveMeshSize(s) "mesh sizes of seives used"
	...
	string SpectralLibraries "Spectral libraries used for material id"
	string CalibrationFrequency "How often is the material id hardware calibrated?"
	string SpectralCollectionMode "ATR, Reflectance, Transmission"
	string AcquisitionStrategy "Single point, mapping, bulk"
	string BackgroundFrequency "Frequency of collecting background signal e.g. every 300 minutes"
	string CollectionTime "Total time of collecting a single spectrum"
	string Smoothing "Was smoothing used?"
	string BaselineCorrection "Was a baseline correction used?"
	string DataTransformation "The type of data transformation used before input to library"
	string MatchThreshold "Threshold used to determine a positive id"
	string SubsamplingMethod "Strategy for subsampling from the sample."
	string PyrolysisMethod "If applicable, describe the pyrolysis GCMS methdology."
